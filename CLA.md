# Commons Contributor License Agreement (CLA)

By making a Contribution to this project, You accept and agree to the following terms
and conditions for Your present and future Contributions. Except for the license granted
herein to the Maintainer and recipients of software distributed by the Maintainer, You
reserve all right, title, and interest in and to Your Contributions.

## 1. Definitions

- **"Maintainer"** means the copyright holder and steward of the Commons project
  (currently the project owner / their designated legal entity).
...
- **"Contribution"** means any original work of authorship, including any modifications
  ...
  Maintainer for inclusion in, or documentation of, any of the projects owned or managed
  by the Maintainer (the **"Work"**). "Submitted" means any form of electronic, verbal,
  or written communication sent to the Maintainer or its representatives, including but
  not limited to communication on electronic mailing lists, source code control systems,
  and issue tracking systems, but excluding communication that is conspicuously marked
...
combination of Your Contribution with the Work to which it was submitted. If any entity
...
1. You are legally entitled to grant the above license. If your employer(s) have rights
   ...
   Maintainer, or that your employer has executed a separate Corporate CLA with the
   Maintainer.
2. Each of Your Contributions is Your original creation (see Section 5 for submissions on
   behalf of others).
3. Your Contribution submissions include complete details of any third-party license or
...
the Maintainer separately from any Contribution, identifying the complete details of its
...
## 7. Agreement to Notify of Inaccuracy
...
Until an automated tool (e.g. [CLA Assistant](https://github.com/cla-assistant/cla-assistant))
is wired up, contributors indicate agreement by adding their name below in a pull request,
**and** by signing off each commit with the Developer Certificate of Origin (`git commit -s`).
